...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/kuyaxxx/vaksin/main/ipsec"

VPN_IPSEC_PSK='bismillah'
...
touch /var/lib/kuyax/data-user-l2tp
touch /var/lib/kuyax/data-user-pptp
rm -f /root/ipsec.sh
